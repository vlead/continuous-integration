...
* Deployment using Apache2 server
...
die-on-term = true
#+END_EXAMPLE
** Create an Upstart File to Manage the App =emacs /etc/init/myapp.conf=
#+BEGIN_EXAMPLE
